...
pdf(file = "./detailed_data/04_output/05_coverage/02_coal/coal_coverage_heatmap.pdf",   
    width = 16, 
    height = 8) 
...
pdf(file = "./detailed_data/04_output/05_coverage/01_general/coverage_important_materials.pdf",   
    width = 16, 
    height = 8) 
