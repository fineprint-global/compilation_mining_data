...
national_production_coal


# table for Rmd output
datatable(coal_cov4, rownames = FALSE, caption = "Total national coal production", options = list(columnDefs = list(list(className = 'dt-center', targets = 0:2))))

###this code chunk is still incomplete !!! 
```
...
pdf(file = "./detailed_data/04_output/05_coverage/coverage_coal/coal_coverage_heatmap.pdf",   
    width = 16, 
    height = 8) 
