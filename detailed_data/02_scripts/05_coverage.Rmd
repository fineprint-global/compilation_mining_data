...
lastfile <- my_lastfile("./detailed_data/01_input/05_other_data/", "data_for_comparison")

nat_acc <- read_delim(
  "./detailed_data/01_input/05_other_data/data_for_comparison_2021-09-28.csv",
...
pdf(file = "./detailed_data/04_output/05_coverage/01_general/mines_per_country.pdf",   
    width = 16, 
    height = 8) 
...
pdf(file = "./detailed_data/04_output/05_coverage/01_general/mines_per_material.pdf",   
    width = 16, 
    height = 8) 
...
pdf(file = "./detailed_data/04_output/05_coverage/01_general/coverage_global.pdf",   
    width = 16, 
    height = 8) 
...
pdf(file = "./detailed_data/04_output/05_coverage/01_general/coverage_national.pdf",   
    width = 16, 
    height = 8) 
