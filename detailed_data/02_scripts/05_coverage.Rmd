...
# table for Rmd output
kable(exc_cov, row.names = FALSE, caption = "Coverages which are >100% for commodities_sheet") %>%
  kable_styling(bootstrap_options =  c("condensed"), font_size = 12)
...
# table for Rmd output
kable(exc_cov, row.names = FALSE, caption = "Coverages which are >100% for minerals_sheet") %>%
  kable_styling(bootstrap_options =  c("condensed"), font_size = 12)
