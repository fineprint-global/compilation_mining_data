...
# 6.1 Validation: check for NA Values where none can be
```{r , echo = FALSE, message = FALSE}
na_tables <- list()
...
# 6.2 Validation: Display graphical summaries to check for outliers/incorrect data
```{r , echo = FALSE, message = FALSE}
...
# 6.3 Validation: validate with SQL schema provided by PGModeler
```{r , echo = FALSE, message = FALSE}
...
# export source_ids, material_ids, unit_ids as TXT files
...
# export source_ids, material_ids, unit_ids as CSV files
