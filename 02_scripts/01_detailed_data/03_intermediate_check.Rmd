...
# table for Rmd output
DT::datatable(double_min_incl_same_source, rownames = FALSE, caption = "Double entries INCLUDING from the same source in minerals sheet")
...
# table for Rmd output
DT::datatable(double_com_incl_same_source, rownames = FALSE, caption = "Double entries INCLUDING from the same source in commodities sheet")
